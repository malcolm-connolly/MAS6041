...
#is there a way to produce the pts list as eulerian path in 3d?
#no
...
#Need also the poles and possibly annotations for the points
...
#\propto
# TeX("Formula: $\\frac{2hc^2}{\\lambda^\\beta}$")            
...
#Dia1 <- as.matrix(sapply(Dia1, as.numeric))
