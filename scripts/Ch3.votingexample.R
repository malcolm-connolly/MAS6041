...
#frequency counts for voting example in lex order
#f<- c(7,8,15,20,25,25,1,1,0,1,0,1,8,20,1,4,1,4,30,30,9,10,9,10)
sum(f)
#f<- c(0,8,10,20,25, 25,1,1,0,1,0,1,8,20,1,4,1,4,30,37,9,10,4,10)
#f <- c( 0,0,10,10,10,70,0,0,0,0,0,0,0,0,2,0,0,0,50,40,4,20,4,20)
#f <- c( 0,0,10,10,40,40,0,0,0,0,0,0,0,0,2,0,0,0,50,40,4,20,4,20)
#f <- c( 5,15,15,20,25,20,0,0,0,0,0,0,0,0,4,0,0,0,50,40,6,30,0,10)
#f <- c(0,0,12,24,12,24,0,0,0,0,0,0,0,0,0,10,0,10,38,30,40,15,10,15)
#f <- c(0,0,12,12,24,24,0,0,0,0,0,0,0,0,0,10,0,5,38,30,40,20,10,15)
